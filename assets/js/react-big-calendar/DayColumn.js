...
function  slot_selection(step, selectDates) {
  var style = 'rbc-slot-selection';
  var difference_select_dates = (selectDates.end - selectDates.start) / (60 * 1000);
  if (difference_select_dates < step)
    style = 'rbc-slot-selection_error';
  return style;
}
  ...
  DaySlot.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      selecting && _react2.default.createElement(
        'div',
        {
            className: slot_selection(step, selectDates),
            style: style
        },
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderEvents = function () {
    ...
    return styledEvents.map(function (_ref, idx) {
      ...
      var delta_height =  0.1;
      var reduce_weight = 3;
      var height = style.height + delta_height,
          top = style.top,
          width = style.width - reduce_weight,
        ...
        _react2.default.createElement(
          'div',
          {
            style: _extends({}, xStyle, (_extends2 = {
              top: top + '%',
              height: height + '%'
            }, _extends2[isRtl ? 'right' : 'left'] = reduce_weight / 2 + 0.5 + '%', _extends2.width = width + '%', _extends2)),
  ...
  this._selectable = function () {
    ...
    var selectionState = function selectionState(_ref2) {
      ...
      var step_time_selection = 30;
      current = snapToSlot(minToDate(mins * current, min), step_time_selection);
