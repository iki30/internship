...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.renderHeader = function renderHeader(range, events, width) {
    ...
    return _react2.default.createElement(
      ...
      // Now, when you clicked to header on timegrid, you go to Agenda calendar page
      // _react2.default.createElement(
      //   'div',
      //   { className: 'rbc-row' },
      //   _react2.default.createElement(
  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    return range.map(function (date, i) {
      ...
      var separating_element = ' -- ';
      var date_format = 'D MMMM YYYY' + separating_element + 'dd';
      var label = _localizer2.default.format(date, date_format, culture);
      var color_day = 'black';
      if (date.getDay() == 0 || date.getDay() == 6)
        color_day = 'red';
      var label_date = label.split(separating_element);
      var title_date = label_date[0];
      var weekday = label_date[1];
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          null,
          _react2.default.createElement('div', {style: {'color': '#a0a0a0'}}, title_date),
          _react2.default.createElement('div', {style: {'color': color_day}}, weekday),
        )
      );
    });
  };
